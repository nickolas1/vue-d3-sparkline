(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-sparkline"] = factory();
	else
		root["vue-sparkline"] = factory();
...
// load the styles
var content = __webpack_require__("mW34");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("rjj0").default
var update = add("308466e6", content, true, {"shadowMode":false,"sourceMap":false});
...
// module
exports.push([module.i, "path{fill:none;stroke:#454f5b;stroke-width:1px}circle{fill:#70563f;stroke-width:1px;stroke:#fff}", ""]);
...
/* harmony default export */ var symbol_triangle = ({
  draw: function(context, size) {
...
// CONCATENATED MODULE: ./src/util/MinHeap.js
...
function () {
  function MinHeap() {
    var comparator = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : MinHeap.defaultComparator();

    classCallCheck_default()(this, MinHeap);

    this.array = [];
    this.comparator = comparator;
  }

  createClass_default()(MinHeap, [{
    key: "push",
    value: function push() {
    ...
    value: function down(i) {
      ...
      while (i >= 0) {
        ...
        var left = right - 1;
        var down = i;
        var child = this.array[down];
        if (left < this.array.length && this.comparator(this.array[left], child) < 0) child = this.array[down = left];
        if (right < this.array.length && this.comparator(this.array[right], child) < 0) child = this.array[down = right];
        if (down === i) break;
...
/* harmony default export */ var util_MinHeap = (MinHeap_MinHeap);
// CONCATENATED MODULE: ./src/util/Visvalingham.js




var Visvalingham_Visvalingham =
/*#__PURE__*/
function () {
  function Visvalingham() {
    classCallCheck_default()(this, Visvalingham);
  }

  createClass_default()(Visvalingham, null, [{
    key: "calculateTriangles",
    value: function calculateTriangles(points, xAccessor, yAccessor) {
      // const heap = new Heap((a, b) => {if (a && b) return a[1]._area - b[1]._area})
      var heap = new util_MinHeap(function (a, b) {
        return a[1]._area - b[1]._area;
      });
      var maxArea = 0;
      var triangles = [];

      for (var i = 1; i < points.length - 1; ++i) {
        var _triangle = points.slice(i - 1, i + 2);

        if (_triangle[1]._area = area(_triangle)) {
          heap.push(_triangle);
      ...
      for (var _i = 0; _i < triangles.length; ++_i) {
        var _triangle2 = triangles[_i];
        _triangle2.previous = triangles[_i - 1];
        _triangle2.next = triangles[_i + 1];
      }
      ...
      while (triangle = heap.pop()) {
        ...
        // eliminated points.
        if (triangle[1]._area < maxArea) triangle[1]._area = maxArea;else maxArea = triangle[1]._area;
      ...
      function area(t) {
        return 0.5 * Math.abs(xAccessor(t[0]) * (yAccessor(t[1]) - yAccessor(t[2])) + xAccessor(t[1]) * (yAccessor(t[2]) - yAccessor(t[0])) + xAccessor(t[2]) * (yAccessor(t[0]) - yAccessor(t[1])));
      }
    }
  }, {
    key: "filter",
    value: function filter(points) {
      var pixelFactor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      var threshold = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.5;
      var result = points.filter(function (d) {
        return d._area * pixelFactor > threshold;
      });
...
/* harmony default export */ var util_Visvalingham = (Visvalingham_Visvalingham);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"/Users/nmoeckel/Github/vue-sparkline/node_modules/.cache/cache-loader"}!./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/SparkLine.vue
//
//
//
//
...
var displayOptions = ["inline", "fill", "newline"];
/* harmony default export */ var SparkLine = ({
  ...
  mounted: function mounted() {
    ...
    if (this.responsive) window.addEventListener("resize", lodash_debounce(this.renderLine, 50));
    util_Visvalingham.calculateTriangles(this.data, this.xAccessor, this.yAccessor);
    this.renderLine();
  },
  ...
  methods: {
    getSvgSize: function getSvgSize() {
      if (this.display === "fill") {
        this.svgHeight = this.$el.offsetHeight;
        this.svgWidth = this.$el.offsetWidth;
      } else {
        this.svgHeight = this.display === "inline" ? parseInt(window.getComputedStyle(this.$el).getPropertyValue("font-size")) : this.height;
    ...
    setScales: function setScales() {
      this.getSvgSize();
      var x = linear_linear().range([0, this.svgWidth - 2 * this.pointRadius]).domain(extent(this.data, this.xAccessor));
      var unitX = Math.abs(x(1) - x(0));
      var y = linear_linear().range([this.svgHeight - 2 * this.pointRadius, 0]).domain(extent(this.data, this.yAccessor));
      var unitY = Math.abs(y(1) - y(0));
      return {
        x: x,
        y: y,
        unitX: unitX,
    ...
    renderLine: function renderLine() {
      ...
      var createLine = src_line().x(function (d) {
        return scales.x(_this.xAccessor(d));
      }).y(function (d) {
        return scales.y(_this.yAccessor(d));
      });
      ...
      if (this.showPoints) {
        ...
        this.data.forEach(function (d, i) {
          _this.points.push({
            x: scales.x(_this.xAccessor(d)),
            y: scales.y(_this.yAccessor(d)),
            r: _this.pointRadius,
            id: i
          });
        });
      ...
      var plotData = util_Visvalingham.filter(this.data, scales.unitX * scales.unitY);
      this.sparkLine = createLine(plotData);
    }
  }
});
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6870a510","hasScoped":false,"optionsId":"1","buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/SparkLine.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"spark-line-container",style:(_vm.style)},[_c('svg',{attrs:{"width":_vm.svgWidth,"height":_vm.svgHeight}},[_c('g',{style:({transform: ("translate(" + _vm.pointRadius + "px, " + _vm.pointRadius + "px)")})},[_c('path',{staticClass:"spark-line",attrs:{"d":_vm.sparkLine}}),(_vm.showPoints)?_c('g',_vm._l((_vm.points),function(point){return _c('circle',{key:point.id,staticClass:"spark-point",attrs:{"cx":point.x,"cy":point.y,"r":point.r}})})):_vm._e()])])])}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./src/components/SparkLine.vue
function injectStyle (context) {
  __webpack_require__("6sOy")
}
/* script */
...
/* harmony default export */ var components_SparkLine = (Component.exports);

// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (components_SparkLine);
...
//# sourceMappingURL=vue-sparkline.umd.js.map